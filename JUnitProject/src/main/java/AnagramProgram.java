...
public class AnagramProgram
{
    static void isAnagram(String s1, String s2)
    {
        ...
        System.out.println("Length of string ---" + copyOfs1.length());
        String copyOfs2 = s2.replaceAll("\\s", "").toLowerCase();
        System.out.println("Length of string2 ---" + copyOfs2.length());
    ...
    private static void isAnagramUsingList(String s1, String s2) {
    	...
    	if (lst.isEmpty()) 
    		System.out.println(s1 + " and " + s2 +" R Anagrams");
    	}
    	}else
    	System.out.println(s1 + " and " + s2 +" r not Anagrams");
    	}
    ...
    public static void main(String[] args)
    {
      //isAnagram("Mother In Law", "Hitler Woman");
       ...
       //   isAnagram("Debit Card", "Bad Credit");
        ...
        //isAnagramUsingList("ASTRONOMERS", "NO MORE STARS");
 
        //isAnagramUsingList("Toss", "S  hot");
